...
```bash
python scripts/run_compress.py /path/to/train.csv
# 可选参数示例
python scripts/run_compress.py /path/to/train.csv --start-col 2 --end-col 31 --codec fp16_zlib
```

脚本会输出 JSON，包含 `manifest`、样本数和基础校验结果。
